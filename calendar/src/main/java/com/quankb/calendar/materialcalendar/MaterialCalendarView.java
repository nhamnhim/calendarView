...
import com.quankb.calendar.R;
import com.quankb.calendar.materialcalendar.format.ArrayWeekDayFormatter;
import com.quankb.calendar.materialcalendar.format.DateFormatTitleFormatter;
import com.quankb.calendar.materialcalendar.format.DayFormatter;
import com.quankb.calendar.materialcalendar.format.MonthArrayTitleFormatter;
    ...
    public void setCalendarDisplayMode(CalendarMode mode) {
        ...
        switch (mode) {
            case MONTHS:
                ...
                break;
            case HAFTMONTH:
                newAdapter = new HaftMonthAdapter(this);
                break;
            case WEEKS:
